...
$tapes = $db->get_tapes($begin, $end, $select_type, $select_container, $active, 1);
  print "<fieldset>";
...
echo("<th><input type=checkbox onClick='toggle(this)' /></th><th>Label</th><th>Type</th><th>Location<BR>Change selected containers:");
